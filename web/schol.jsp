<%-- 
    Document   : schol
    Created on : Apr 27, 2018, 3:17:18 AM
    Author     : USER
--%>
   ...
   <div class="centered"><h2> Welcome To AVI Institute</h2>
	...
	<form action="Logout" method="post">
		<input type="submit" value="Logout">
                             ...
                             <div>      <h1 style="text-align:center; color:MediumSeaGreen; margin-top:4%;">Scholarship Request Form</h1>
               <form method="POST" action="AddScholarshipServlet">
  <table>
  <tr>
...
%>
   ...
   %>
  </td></tr><tr><td>Your GPA:</td>
  <td> <input type="text" name="gpa"> <br>
