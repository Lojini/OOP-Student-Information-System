<%-- 
    ...
    Created on : Apr 27, 2018, 3:16:20 AM
    Author     : USER
--%>
     ...
     <%
                                  ...
                                  try {
                                   ...
                                   while(resultSet.next()){
                                      %>
  <h1 style="text-align:center; color:MediumSeaGreen; margin-top:4%;"><%=resultSet.getString(2) %></h1>
                                      <tr>
    <td width="20%">About:</td>
   <td><%=resultSet.getString(3) %></td>
   
  </tr>
                  <%            } String query1 = "select * from subject where CourseId='"+id+"'";
                                    ResultSet resultSet1 = myStm.executeQuery(query1);
                                   while(resultSet1.next()){%>
  <tr>
    <td colspan="2"> <a href="subjects.jsp?id=<%=resultSet1.getString(2)%>" style="text-decoration:none; color:black;"><%=resultSet1.getString(2) %></a></td>
   ...
   <tr><td><h4><a href="ResultSheet.jsp">Result Sheet</a></h4></td></tr>
</table>
