<%-- 
    Document   : courses
    Created on : Apr 27, 2018, 3:15:55 AM
    Author     : USER
--%>
...
<body>
  ...
  <a href="index.jsp" style="margin-left:700px; margin-top:60px;margin-right:30px;">Home</a>
   ...
   <div class="centered"><h2> Welcome To AVI Institute</h2>
	...
	<form action="Logout" method="post">
		<input type="submit" value="Logout">
                               ...
                               <div>       <h1 style="text-align:center; color:MediumSeaGreen; margin-top:4%;">Our Courses</h1>
                                        <table>
...
<tr><td><a href="course-details.jsp?id=<%=resultSet.getString(1)%>" style="text-decoration:none; color:black;"><%=resultSet.getString(2)%></a></td></tr>
  <%
      }
   connection.close();
    } 
