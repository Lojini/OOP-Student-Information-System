...
public final class courses_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("                               <div>       <h1 style=\"text-align:center; color:MediumSeaGreen; margin-top:4%;\">Our Courses</h1>\n");
      out.write("                                        <table>\n");
      out.write("\n");
      out.write(" \n");
      out.write("      ");
  ...
  try{
     ...
     while(resultSet.next()){
         if (session != null) {
			if (session.getAttribute("Username") != null) {
                           String query1 ="SELECT c.CourseName FROM c.course,r.register where r.StudentRegNo='"+Id+"'";
                            ResultSet resultSet1 = myStm.executeQuery(query1);
      out.write("\n");
      out.write("                            \n");
      out.write("              <td><a href=\"course-details.jsp?id=");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<tr><td><a href=\"course-details.jsp?id=");
